...
def main():
    ...
    parser.add_argument("--max-tokens", "-m", type=int, default=512, help="Maximum token length")
    parser.add_argument("--categories", "-c", type=str, nargs='+', default=None, help="Categories to process")
